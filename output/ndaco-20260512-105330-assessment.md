...
| Metric | Value |
|---|---|
| NRG Composite Score | **46 / 100** |
| Controls Satisfied | 22 |
| Partial | 7 |
| Gaps | 26 |
| Not Applicable | 20 |
| Total | 75 |
...
| 🟢 Pass | Informational | Shared mailbox sign-in disabled | All 1 shared mailbox(es) have sign-in disabled. |
...
| ⬜ N/A | Medium | Customer Lockbox enabled | Customer Lockbox data not available. Requires Microsoft 365 E5 or Customer Lockbox add-on license. |
...
| 🔴 Gap | Low | Third-party cloud storage apps disabled in Teams | Third-party cloud storage enabled in Teams: GoogleDrive, DropBox, Box, ShareFile. Users can share files from unmanaged external storage, bypassing DLP and retention policies. |
